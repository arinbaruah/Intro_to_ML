...
- On the other hand, variables such as __"Innings","Not outs", "Strike rate","Sixes","Ducks","High score","Balls faced"__ points towards nearly 90 degrees to the set of variables in the above bullet point. This means that aforementioned set of variables contribute __towards the PC1 variable and are also correlated as they are observed to be pointing generally in a similar direction.__
